...
pub const COMPILATION_TIME: &str = "11:40:22";
...
pub const MAKEFLAGS: &str = "-j --jobserver-fds=__rust_jobserver_semaphore_3714162316 --jobserver-auth=__rust_jobserver_semaphore_3714162316";
