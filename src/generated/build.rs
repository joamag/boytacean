...
pub const COMPILATION_DATE: &str = "Mar 05 2025";
pub const COMPILATION_TIME: &str = "11:44:48";
pub const NAME: &str = "boytacean";
pub const VERSION: &str = "0.11.3";
pub const COMPILER: &str = "rustc";
pub const COMPILER_VERSION: &str = "1.85.0";
...
pub const MAKEFLAGS: &str = "-j --jobserver-fds=__rust_jobserver_semaphore_1700272973 --jobserver-auth=__rust_jobserver_semaphore_1700272973";
