...
pub trait SerialDevice {
    ...
    /// simulating an external clock source. If false the clock
    /// should always be generated by the running Game Boy.
    ...
    /// a specific clock mode. Returns Some(true) to force master mode,
    /// Some(false) to force slave mode, or None to use the game's setting.
