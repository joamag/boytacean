...
impl GbaBus {
    ...
    fn read_io16(&mut self, addr: u32) -> u16 {
        match addr {
            ...
            REG_TM0CNT_L => self.timers.read_counter(0),
            REG_TM0CNT_H => self.timers.timers[0].control(),
            REG_TM1CNT_L => self.timers.read_counter(1),
            REG_TM1CNT_H => self.timers.timers[1].control(),
            REG_TM2CNT_L => self.timers.read_counter(2),
            REG_TM2CNT_H => self.timers.timers[2].control(),
            REG_TM3CNT_L => self.timers.read_counter(3),
    ...
    fn write_io16(&mut self, addr: u32, value: u16) {
        match addr {
            ...
            REG_TM0CNT_L => self.timers.write_reload(0, value),
            REG_TM0CNT_H => self.timers.write_control(0, value),
            REG_TM1CNT_L => self.timers.write_reload(1, value),
            REG_TM1CNT_H => self.timers.write_control(1, value),
            REG_TM2CNT_L => self.timers.write_reload(2, value),
            REG_TM2CNT_H => self.timers.write_control(2, value),
            REG_TM3CNT_L => self.timers.write_reload(3, value),
            REG_TM3CNT_H => self.timers.write_control(3, value),
